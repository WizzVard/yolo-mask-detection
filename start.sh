...
IMAGE_NAME="yolo"  # Set the docker image name
IMAGE_TAG="latest"           # Set the docker image tag
FULL_IMAGE_NAME="${IMAGE_NAME}:${IMAGE_TAG}"
WORKING_DIR="//home/app"
LOCAL_INFERENCE_RESULTS_DIR="C:\Users\WizzVard\PycharmProjects\YOLO\app\data\inference"  # Set the local inference results directory
LOCAL_DATA_DIR="C:\Users\WizzVard\PycharmProjects\YOLO\app\data"                         # Set the local data directory
DOCKER_INFERENCE_RESULTS_DIR="${WORKING_DIR}/data/inference"
